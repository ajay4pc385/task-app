...
<div 
        ...
        className="relative height-about w-full bg-cover bg-center rounded-lg transition-opacity duration-1000 absolute inset-0 rounded-lg border-l-4 border-b-4 border-orange-500 pointer-events-none"
        data-aos="fade-up"
        style={{
