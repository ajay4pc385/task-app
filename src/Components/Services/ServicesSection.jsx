...
<div className='row mt-4 mb-2'>
    ...
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we specialize in guiding you through every step of your home loan journey.&nbsp;</span></p><p className=" text-gray-500"><span style={{fontWeight: "400"}}> looking to refinance for better rates and terms, or investing in property to build your portfolio, our expert team is here to provide personalized solutions tailored to your financial goals. </span></p>			
                        			</div>
                                    </div>
  <div className="col-md-12 services-box mt-4 mb-2" data-aos="fade-up">
  <div className="d-flex gap-5 align-items-center">
  <MdOutlineDocumentScanner className="fs-1 text-orange-500 font-bold"/>
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>Refinancing is the process of replacing an existing loan with a new one, typically to take advantage of better terms, such as a lower interest rate, a different loan term, or to switch from an adjustable-rate mortgage to a fixed-rate mortgage. Homeowners often refinance to reduce their monthly mortgage payments, pay off their loan  through a cash-out refinance. &nbsp;</span></p>						</div>
  </div>
  ...
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we offer expert guidance on Self-Managed Super Fund (SMSF) loans to help you maximize your investment potential. 
  ...
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we offer a range of personal loan options designed to meet your unique financial needs. 
  ...
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we specialize in providing comprehensive commercial and business loan solutions tailored to your unique needs.. &nbsp;</span></p>				</div>
  </div>
    </div>
    <div className='col-md-4'>
    <div className="col-md-12 services-box " data-aos="fade-up">
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>
At Alphaa Financial Solutions, we offer tailored asset and vehicle finance solutions to help you acquire the equipment or vehicle you need with ease. 
  ...
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we offer tailored asset and vehicle finance solutions to help you acquire the equipment or vehicle you need with ease. 
...
Whether you’re looking to purchase a new car, upgrade your business equipment, or finance a fleet, our team provides expert advice and customized financing options. &nbsp;</span></p>					</div>
  ...
  <div className="d-flex gap-5 align-items-center">
    ...
    <hr/>
    <div class="elementor-widget-container">
						<p className=" text-gray-500"><span style={{fontWeight: "400"}}>At Alphaa Financial Solutions, we offer specialized expat loan services designed to meet the unique needs of expatriates. 
