  ...
  return (
    <>
      <section className="bg-gray-900 text-white py-12">
        ...
        {/* Bottom Statistics */}
        <div className="container mx-auto px-4 mt-8 flex flex-wrap justify-end gap-4 " style={{position:"relative" , top:"-170px" , left:"50px " }}>
          ...
          <div className="bg-white text-gray-900 p-4 rounded-lg text-center w-1/4 md:w-1/6 hero-section" style={{position:"relative" , top:"-10px" , }}>
