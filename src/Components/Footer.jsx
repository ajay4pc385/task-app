...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 text-white py-8">
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-5 right-5 bg-orange-500 text-white p-3 rounded-full shadow-lg transition-transform duration-300 ease-in-out hover:bg-orange-300 hover:scale-110"
      >
        <FaArrowUp />
      </button>
    </footer>
